...
//    private Date dateconge;
    ...
    public Conge(){}
    public Conge( String dateconge, String motifconge, int nbjourconge,int employe_id) {
    ...
    public Conge(int idconge, String dateconge, String motifconge, int nbjourconge,int employe_id) {
    ...
    public Conge(String dateconge, String motifconge, int nbjourconge) {
        this.dateconge = dateconge;
        this.motifconge = motifconge;
        this.nbjourconge = nbjourconge;
    }

    public Conge(String motifconge, int nbjourconge) {
        this.motifconge = motifconge;
        this.nbjourconge = nbjourconge;
    }
