 ...
 * @author ASUS
 */
public class ListCatForm extends BaseFormP{
    Form current;
     private TextField recherche;
     
    public ListCatForm(Resources res){
        super("List Catégorie",BoxLayout.y()); //heritage de Newsfeed & le formulaire est verctical
...
add(lab);
        ...
        new SearchCat(res,recherche.getText()).show()
);
       add(recherche);
