...
public class Abonne {
   ...
   public static Abonne abonne=new Abonne();
    ...
    public String toString() {
        return "Abonne{" + "id=" + id + ", nomabonne=" + nomabonne + ", prenomabonne=" + prenomabonne + ", mailabonne=" + mailabonne + ", datenaissabonne=" + datenaissabonne + ", telephoneabonne=" + telephoneabonne + ", password=" + password + '}';
    }
